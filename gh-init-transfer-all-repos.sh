...
This script initilizes a transfer ALL (public + private) repositories in the <github-username> organization
It shows the visibility of each initialized repository transfer
